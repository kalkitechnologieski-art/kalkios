...
export default function ProfilePage() {
  ...
  const roleColors: Record<string, string> = {
    ...
    manager: 'text-blue-400 border-blue-500/30 bg-blue-600/10',
    developer: 'text-green-400 border-green-500/30 bg-green-600/10',
    hr: 'text-pink-400 border-pink-500/30 bg-pink-600/10',
    support: 'text-yellow-400 border-yellow-500/30 bg-yellow-600/10',
    client: 'text-white/40 border-white/10 bg-white/5',
  }
        ...
        <div className="relative p-6 md:p-8 flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            <button
              ...
              className="px-4 py-2 bg-red-500/10 hover:bg-red-500/20 rounded-lg text-red-400 text-sm font-mono transition border border-red-500/20 flex items-center gap-2"
            >
