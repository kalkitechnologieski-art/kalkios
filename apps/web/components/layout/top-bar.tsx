...
export function TopBar({ onMenuClick }: { onMenuClick: () => void }) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 h-14 bg-black/90 backdrop-blur-xl border-b border-white/5 flex items-center justify-between px-4 md:px-6">
      <button
        onClick={onMenuClick}
