...
# ============================================================================
# SIDDHI AI – STREAM CONTENT FIX
# ============================================================================
# Fixes the empty response by properly extracting content from router.
# ============================================================================
...
LOG_FILE="${ROOT_DIR}/stream_fix_${TIMESTAMP}.log"

log() {
  echo "[$(date '+%Y-%m-%d %H:%M:%S')] $*" | tee -a "$LOG_FILE"
}

log "Starting stream content fix..."
...
# -----------------------------------------------------------------------------
# 1. Rewrite the stream route with proper content extraction
# -----------------------------------------------------------------------------
...
STREAM_EOF
log "Updated stream route with proper content extraction"
...
log "============================================================="
log "Stream content fix complete."
log "The route now handles all result types and extracts content properly."
